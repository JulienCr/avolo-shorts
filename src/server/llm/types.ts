...
/**
 * Le mode d'appel du repérage. **Défini ici, réexporté sous le nom
 * `ModeGemini`** par `src/server/steps/candidates.ts`, qui l'utilisait avant
 * que cette couche existe et dont la couture de test —
 * `tests/server/candidates.test.ts`, environ 1800 lignes — s'y accroche par ce
