 ...
 * pas de `META_APP_ID`/`META_APP_SECRET` ni de jeton persisté pour Instagram,
 * pas de `META_PAGE_ID`/`META_PAGE_TOKEN` pour Facebook.
 */
async function availability(
  ...
  if (appConfigured && (await readMetaTokens()) !== null) {
